...
class Keranjang_model extends CI_Model
{
    public function get_by_customer($id_customer)
    {
        return $this->db->select(' cart.id_cart,cart.qty,cart.checklist,item.id_item,item.merk,item.nama_item,item.gambar_item,
            kategori.nama_kategori,item_detail.id_item_detail,item_detail.warna,item_detail.ukuran,item_detail.harga,COALESCE(MIN(CASE WHEN item_detail.stok > 0 THEN item_detail.harga END),
