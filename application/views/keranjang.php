<style>
    ...
    @media (max-width: 575.98px) {
        ...
        .product-info .text-primary.small,
        .product-info small {
        ...
        .product-info .text-decoration-line-through {
            font-size: 0.72rem !important;
        }
        .item-checkbox {
                            ...
                            foreach ($cart as $index => $c):
                                ...
                                <div class="col-12 p-0 cart-item <?= $is_empty ? 'cart-empty' : '' ?>" id="cart-<?= $c->id_cart ?>">
                                    <div class="single-product product-card position-relative"
                                        ...
                                        <?php endif; ?>
                                        <div class="product-image position-relative flex-shrink-0" style="width: 150px; height: 150px; min-width: 150px;">
                                            <a href="<?= site_url('detailproduct/' . $c->id_item) ?>" class="detail-link h-100 d-block">
                                                <img src="<?= base_url('assets/images/item/' . $c->gambar) ?>"
                                                    class="img-fluid product-img h-100"
                                                    style="object-fit: cover; width: 150px; height: 150px; display: block; <?= $is_empty ? 'filter: grayscale(60%);' : '' ?>"
                                        ...
                                        <div class="product-info d-flex flex-column flex-grow-1 p-2 p-md-3"
                                            data-id-cart="<?= $c->id_cart ?>"
                                            data-price="<?= $subtotal ?>">
                                            <div class="d-flex justify-content-between align-items-start gap-1">
                                                <div class="flex-grow-1" style="min-width: 0;">
                                                    <span class="category text-primary" style="font-size: 0.75rem;">
                                                        <?= htmlspecialchars($c->nama_kategori) ?> | <?= htmlspecialchars($c->merk) ?>
                                                    </span>
                                                    <h4 class="title mb-1" style="font-size: 0.95rem; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;
                                                        overflow: hidden; text-overflow: ellipsis; white-space: normal; line-height: 1.5; padding-bottom: 2px;">
                                                ...
                                                <div class="flex-shrink-0 d-flex align-items-center gap-1 ms-1">
                                                    ...
                                                    <button class="btn btn-sm btn-danger btn-hapus-item"
                                                        ...
                                                        <i class="lni lni-trash-can" style="font-size: 16px;"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            <div class="d-flex flex-wrap align-items-center gap-1 mt-1" style="font-size: 0.85rem;">
                                                <span class="text-primary"><?= htmlspecialchars($c->jenis_kelamin) ?> | <?= htmlspecialchars($c->usia_min) ?> - <?= htmlspecialchars($c->usia_max) ?></span>
                                                <span class="text-muted">·</span>
                                                <?php if (!empty($c->warna)): ?>
                                                    <span class="color-circle" style="width: 14px; height: 14px; border-radius: 50%; background-color: <?= $c->kode_hex ?? '#ccc' ?>; display: inline-block; border: 1px solid #ddd;" title="<?= htmlspecialchars($c->warna) ?>"></span>
